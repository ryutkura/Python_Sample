...
def _cec17_test_func(x, nx, func_num, s_flag, r_flag):
    ...
    # 元は+関数の番号*100の演算してる
    func_map = {
        1: lambda: _bent_cigar_func(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        3: lambda: _zakharov_func(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        4: lambda: _rosenbrock_func(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        5: lambda: _rastrigin_func(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        6: lambda: _schaffer_F7_func(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        7: lambda: _bi_rastrigin_func(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        8: lambda: _step_rastrigin_func(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        9: lambda: _levy_func(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        10: lambda: _schwefel_func(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        11: lambda: _hf01(x, nx, OShift, M, SS, s_flag, r_flag) + 0.0,
        12: lambda: _hf02(x, nx, OShift, M, SS, s_flag, r_flag) + 0.0,
        13: lambda: _hf03(x, nx, OShift, M, SS, s_flag, r_flag) + 0.0,
        14: lambda: _hf04(x, nx, OShift, M, SS, s_flag, r_flag) + 0.0,
        15: lambda: _hf05(x, nx, OShift, M, SS, s_flag, r_flag) + 0.0,
        16: lambda: _hf06(x, nx, OShift, M, SS, s_flag, r_flag) + 0.0,
        17: lambda: _hf07(x, nx, OShift, M, SS, s_flag, r_flag) + 0.0,
        18: lambda: _hf08(x, nx, OShift, M, SS, s_flag, r_flag) + 0.0,
        19: lambda: _hf09(x, nx, OShift, M, SS, s_flag, r_flag) + 0.0,
        20: lambda: _hf10(x, nx, OShift, M, SS, s_flag, r_flag) + 0.0,
        21: lambda: _cf01(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        22: lambda: _cf02(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        23: lambda: _cf03(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        24: lambda: _cf04(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        25: lambda: _cf05(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        26: lambda: _cf06(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        27: lambda: _cf07(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        28: lambda: _cf08(x, nx, OShift, M, s_flag, r_flag) + 0.0,
        29: lambda: _cf09(x, nx, OShift, M, SS, s_flag, r_flag) + 0.0,
        30: lambda: _cf10(x, nx, OShift, M, SS, s_flag, r_flag) + 0.0,
    }
